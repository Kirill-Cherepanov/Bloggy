...
export const blogInfo: PublicData = {
  username: 'KissMyUSSR',
...
export const getPostsData = (postsAmount: number): PostData[] => {
  return Array(postsAmount)
    ...
    .map((v, i) => ({
      ...
      description:
        "300 characters is a bit long but I'll try, alright? This is a description for a post. I decided that putting a lorem here would be way too boring and maybe I just wanted to write down some nonsensical stuff. Actually originally it was 200 but I decided that NormalPost may fit a bit more than that :)",
      image: mockImage,
      categories: [
        'Science',
